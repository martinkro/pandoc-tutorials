...
\lhead{}
\chead{}
\rhead{\includegraphics[width=1.2cm]{{girl-3.eps}}
\lfoot{}
\cfoot{}
\rfoot{}
...
\SetWatermarkText{\includegraphics{{girl-1.eps}}         % 设置水印logo
...
\section{章节 Section} \label{sec:one}
    ...
    \begin{figure}[htbp] 
		\centering
		\includegraphics[width=0.2\textwidth]{girl-1.eps}
		\includegraphics[width=0.2\textwidth]{girl-3.eps}
		\caption{figure 1}		
		\label{figure:zju1}
	\end{figure}
    ...
    \begin{figure}[htbp] 		
		\centering
		\includegraphics[width=0.2\textwidth]{girl-3.eps}
		\includegraphics[width=0.2\textwidth]{girl-4.eps}
		\caption{figure 2}
		\label{figure:zju2}		
	\end{figure}
